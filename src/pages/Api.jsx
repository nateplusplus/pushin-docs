...
export default function Api() {
  ...
  const pushinRows = [
    ...
    createData('mode', <code>data-pushin-mode</code>, <code>string</code>, <code>sequential</code>, <code>sequential, continuous</code>, <><p>Specify how PushIn layers should be displayed.</p><ul><li><code>continuous</code> - display all layers continuously throughout the animation.</li><li><code>sequential</code> - display layers in a sequence, one after another.</li></ul></>),
